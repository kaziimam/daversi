                                        ...
                                        foreach($data as $data){ ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <!-- <a onclick="deleteorder()"><i> <img src="<?php //echo base_url('assets/images/icon/delete_round_border.svg') ?> " height="19px" width="19px"></i></a>
                                                    <a href="<?php //echo base_url('/index.php/admin/edit_order/').$data['id']; ?>" style=""><i> <img src="<?php //echo base_url('assets/images/icon/edit_icon.svg') ?>" height="10"></i></a> -->
                                                </td>
                                            </tr>
                                       <?php $sr++;  }
                                     ?>
