                                ...
                                $sr = 1;
                                    foreach($data as $data){ ?>
                                        <tr>
                                            <td><?php echo $sr ;?></td>
                                            <td>
                                                <img class="img-responsive" height="50" src="<?php echo  base_url('/assets/images/product/').$data['image']?>">
                                            </td>
                                            ...
                                            <td width="110">
                                                <a onclick="delete_buy_product()"><i> <img src="<?php echo base_url('assets/images/icon/delete_round_border.svg') ?> " height="25px"></i></a>
                                                <a href="<?php echo base_url('/index.php/admin/edit_buy_product/').$data['id']; ?>" style="margin: 5px;border-radius: 50px;border: 1px solid;padding: 1px 5px 5px 5px;"><i> <img src="<?php echo base_url('assets/images/icon/edit_icon.svg') ?>" height="15"></i></a>
                                            </td>
                                        </tr>
                                   <?php $sr++;  }
                                 ?>
