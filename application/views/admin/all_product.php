                            ...
                            <tbody>
                                    ...
                                    $sr = 1;
                                        foreach($data as $products){ ?>
                                            <tr>
                                                <td><?php echo $sr ;?></td>
                                                <td  width="85"> <a href=""><img class="img-responsive" src="<?php echo base_url('/assets/images/product/').$products['product_img'] ;?>" height = '50px'></a></td>
                                                <td width="150"><a href=""></a><?php echo $products['product_name']; ?></td>
                                                <td>
                                                    <img class="img-responsive" src="<?php echo base_url('/assets/images/place/').$products['place_img'] ;?>" style="height: 50px; border-radius: 50px;">
