...
<div class="peers ai-s fxw-nw h-100vh">
        <div class="d-n@sm- peer peer-greed h-100 pos-r bgr-n bgpX-c bgpY-c bgsz-cv" style="background-image:url('<?php echo base_url("assets/images/bg.png");?>')">
            <div >
                <div class="pos-a centerXY">
                    <div class="bgc-white bdrs-50p pos-r" style="width:120px;height:120px">
                        <img class="pos-a centerXY" src="<?php echo base_url('assets/images/logo.png')?>" height="80" alt="">
                    </div>
                </div>
            </div>
