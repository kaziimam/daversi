        ...
        <div class="sidebar-inner">
            ...
            <ul class="sidebar-menu scrollable pos-r">
                ...
                <li class="nav-ite active">
                    <a class="sidebar-link" href="<?php echo base_url('/admin/admin_user')?>"><span class="icon-holder"><i class="c-red-500 ti-user"></i> </span><span class="title">My Profile</span></a>
                </li>

                <li class="nav-item"><a class="sidebar-link" href="<?php echo base_url('index.php/admin/users') ?>"><span class="icon-holder"><i class="c-blue-500 ti-user"></i> </span><span class="title">Users</span></a></li>
                ...
                <li class="nav-item"><a class="sidebar-link" href="<?php echo base_url('index.php/admin/place')?>"><span class="icon-holder"><i class="c-deep-purple-500  ti-bar-chart"></i> </span><span class="title">Sellers </span></a></li>

                <li class="nav-item"><a class="sidebar-link" href="<?php echo base_url('index.php/admin/order') ?>"><span class="icon-holder"><i class="c-red-500 fa fa-shopping-cart fa-lg"></i> </span><span class="title">Orders</span></a></li>
                <li class="nav-item"><a class="sidebar-link" href="<?php //echo base_url('index.php/admin/order') ?>"><span class="icon-holder"><i class="c-deep-purple-500 fa fa-universal-access fa-lg"></i> </span><span class="title">Access Module</span></a></li>
                <li class="nav-item"><a class="sidebar-link" href="<?php //echo base_url('index.php/admin/order') ?>"><span class="icon-holder"><i class="c-green-600 fa fa-tag fa-lg"></i> </span><span class="title">Coupon Code</span></a></li>
            </ul>
        </div>
    </div>
</div>
